...
--
-- Generation Time: May 22, 2012 at 08:37 PM
-- Generated by: http://zooku.ro
...
--
-- Database: `east_wolf_com_thenaughtyandthenice`
--
...
--
-- Creation: May 22, 2012 at 08:33 PM
--
...
--
-- Table structure for table `ad_traffic`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `ad_traffic`;
...
--
-- Dumping data for table `ad_traffic`
--

LOCK TABLES `ad_traffic` WRITE;
...
--
-- Table structure for table `banned_countries`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `banned_countries`;
...
--
-- Dumping data for table `banned_countries`
--

LOCK TABLES `banned_countries` WRITE;
...
--
-- Table structure for table `banned_states`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `banned_states`;
...
--
-- Dumping data for table `banned_states`
--

LOCK TABLES `banned_states` WRITE;
...
--
-- Table structure for table `credits_detail`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `credits_detail`;
...
--
-- RELATIONS FOR TABLE `credits_detail`:
--   `credit_id`
--       `credits` -> `id`
--

--
-- Dumping data for table `credits_detail`
--

LOCK TABLES `credits_detail` WRITE;
...
--
-- Table structure for table `failure_logins`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `failure_logins`;
...
--
-- Dumping data for table `failure_logins`
--

LOCK TABLES `failure_logins` WRITE;
...
--
-- Table structure for table `newsletter_cron`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `newsletter_cron`;
...
--
-- Dumping data for table `newsletter_cron`
--

LOCK TABLES `newsletter_cron` WRITE;
...
--
-- Dumping data for table `performers_categories`
--

LOCK TABLES `performers_categories` WRITE;
...
--
-- Table structure for table `performers_favorites`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_favorites`;
...
--
-- Dumping data for table `performers_favorites`
--

LOCK TABLES `performers_favorites` WRITE;
...
--
-- Table structure for table `performers_languages`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_languages`;
...
--
-- Dumping data for table `performers_languages`
--

LOCK TABLES `performers_languages` WRITE;
...
--
-- Table structure for table `performers_photos`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_photos`;
...
--
-- RELATIONS FOR TABLE `performers_photos`:
--   `performer_id`
--       `performers` -> `id`
--

--
-- Dumping data for table `performers_photos`
--

LOCK TABLES `performers_photos` WRITE;
...
--
-- Table structure for table `performers_photo_id`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_photo_id`;
...
--
-- Dumping data for table `performers_photo_id`
--

LOCK TABLES `performers_photo_id` WRITE;
...
--
-- Table structure for table `performers_ping`
--

DROP TABLE IF EXISTS `performers_ping`;
...
--
-- Dumping data for table `performers_ping`
--

LOCK TABLES `performers_ping` WRITE;
...
--
-- Table structure for table `performers_profile`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_profile`;
...
--
-- RELATIONS FOR TABLE `performers_profile`:
--   `performer_id`
--       `performers` -> `id`
--

--
-- Dumping data for table `performers_profile`
--

LOCK TABLES `performers_profile` WRITE;
...
--
-- Table structure for table `performers_ratings`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_ratings`;
...
--
-- Dumping data for table `performers_ratings`
--

LOCK TABLES `performers_ratings` WRITE;
...
--
-- Table structure for table `performers_reviews`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_reviews`;
...
--
-- Dumping data for table `performers_reviews`
--

LOCK TABLES `performers_reviews` WRITE;
...
--
-- Table structure for table `performers_schedules`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_schedules`;
...
--
-- Dumping data for table `performers_schedules`
--

LOCK TABLES `performers_schedules` WRITE;
...
--
-- Table structure for table `performers_videos`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `performers_videos`;
...
--
-- RELATIONS FOR TABLE `performers_videos`:
--   `performer_id`
--       `performers` -> `id`
--

--
-- Dumping data for table `performers_videos`
--

LOCK TABLES `performers_videos` WRITE;
...
--
-- Table structure for table `test_gateway_processor`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `test_gateway_processor`;
...
--
-- Dumping data for table `test_gateway_processor`
--

LOCK TABLES `test_gateway_processor` WRITE;
...
--
-- RELATIONS FOR TABLE `users_detail`:
--   `user_id`
--       `users` -> `id`
--
...
--
-- Table structure for table `watchers_old`
--
-- Creation: May 22, 2012 at 08:33 PM
--

DROP TABLE IF EXISTS `watchers_old`;
...
--
-- Dumping data for table `watchers_old`
--

LOCK TABLES `watchers_old` WRITE;
...
--
-- Constraints for table `credits_detail`
--
ALTER TABLE `credits_detail`
  ADD CONSTRAINT `credits_detail_ibfk_1` FOREIGN KEY (`credit_id`) REFERENCES `credits` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `performers_photos`
--
ALTER TABLE `performers_photos`
  ADD CONSTRAINT `performers_photos_ibfk_1` FOREIGN KEY (`performer_id`) REFERENCES `performers` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `performers_profile`
--
ALTER TABLE `performers_profile`
  ADD CONSTRAINT `performers_profile_ibfk_1` FOREIGN KEY (`performer_id`) REFERENCES `performers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `performers_videos`
--
ALTER TABLE `performers_videos`
  ADD CONSTRAINT `performers_videos_ibfk_1` FOREIGN KEY (`performer_id`) REFERENCES `performers` (`id`) ON DELETE CASCADE;
