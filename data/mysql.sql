...
INSERT INTO `admins` (`id`, `username`, `password`, `hash`, `status`) VALUES
	(1, 'admin', '0f86bc4eb772717ff2e9213a4a55b7ab6fc172aa6fbd1570251de90077519cb5', 'e2d87d4698e342d71c6ae31d3df1b3a990778b15', 'approved');
...
INSERT INTO `failure_logins` (`id`, `ip`, `failed_logins`, `last_failure`, `username`) VALUES
	(1, 2147483647, 1, 1337606136, 'sample1');
...
INSERT INTO `settings` (`id`, `name`, `value`, `type`, `title`, `description`) VALUES
	...
	(6, 'support_name', 'Thibaut Mbega', 'string', 'Support name', NULL),
...
# Dumping data for table east_wolf_com_thenaughtyandthenice.system_logs: ~1 rows (approximately)
/*!40000 ALTER TABLE `system_logs` DISABLE KEYS */;
INSERT INTO `system_logs` (`id`, `date`, `actor`, `actor_id`, `action_on`, `action_on_id`, `action`, `ip`, `key`, `action_comment`) VALUES
	(1, 1337605950, 'admin', 1, 'admin', 1, 'login', 2147483647, NULL, 'Admin has logged in.'),
	(2, 1337606122, 'admin', 1, 'performer', 1, 'edit_account', 2147483647, NULL, 'Admin edited performer account information.'),
	(3, 1337606178, 'performer', 1, 'performer', 1, 'login', 2147483647, NULL, 'Performer has logged in.');
