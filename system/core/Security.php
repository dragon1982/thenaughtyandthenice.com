...
class CI_Security {
	...
	protected $_xss_hash			= '';
	public		 $_csrf_hash			= '';
	protected $_csrf_expire			= 93600;  // Two hours (in seconds)
	...
	public function csrf_verify()
	{
		...
		$skip = FALSE;
		if( file_exists( APPPATH.'config/ignore_links.php' ) ){
			require_once APPPATH.'config/ignore_links.php';
		} else {
			$config['ignore_links'] = array();
		}
		
		$links =  $config['ignore_links'];
