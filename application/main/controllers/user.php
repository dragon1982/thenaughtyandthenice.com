...
Class User_controller extends MY_Users{
	...
	function update_chips(){
		...
		$data['json'] = array(
				'credits'=> print_amount_by_currency($this->user->credits),
				//'fee_per_minute'=> $this->active_session->fee_per_minute,
				//'active_session'=> $this->active_session->type,
