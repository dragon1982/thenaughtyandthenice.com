	                	...
	                	<li>
	                    	<article class="box-t1 clearfix">
	                            ...
	                            <div class="prefix-10 set-top-10">
									...
									<?php echo form_open('relation/ban', array('id'=>'ban_relation_form', 'method'=>'post')); ?>
										<input type="hidden" name="rel_id" value="<?php echo $friend->rel_id; ?>" />
									</form>
	                              	<a class="btn-nice-5 " href="javascript:;" onclick="$('#delete_relation_form').submit();">Remove</a>
	                                <a class="btn-nice-5 " href="javascript:;" onclick="$('#ban_relation_form').submit();">Ban</a>
	                            </div>
	                        </article>
	                    </li>
                    <?php endforeach; ?>
