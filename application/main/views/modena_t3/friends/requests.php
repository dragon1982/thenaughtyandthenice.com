<section class="set-bott-1">
                <header class="box-header clearfix">
                    ...
                    <ul class="tabs-t1 left set-tabs-pos">
                        ...
                        <li class="selected"><a href="<?php echo site_url('friends/requests'); ?>">Requests</a></li>
                        <li><a href="<?php echo site_url('friends/banned'); ?>">Banned</a></li>
                    </ul>
                </header>
	                	...
	                	<li>
	                    	<article class="box-t1 clearfix">
	                            ...
	                            <div class="prefix-10 set-top-10">
	                                ...
	                                <br>
	                                <br>
									<?php echo form_open('relation/accept', array('id'=>'accept_relation_form', 'method'=>'post')); ?>
									...
									<?php echo form_open('relation/delete', array('id'=>'delete_relation_form', 'method'=>'post')); ?>
	                              	...
	                              	<a class="btn-nice-5 " href="javascript:;" onclick="$('#accept_relation_form').submit();">Accept</a>
	                                <a class="btn-nice-5 " href="javascript:;" onclick="$('#delete_relation_form').submit();">Refuse</a>
	                            </div>
	                        </article>
	                    </li>
                    <?php endforeach; ?>
