	...
	<table cellpadding="0" cellspacing="0" style="width: 600px; font-family: Arial; font-size: 14px; text-align: left; color: #505050; border: solid #DDDDDD 1px; padding: 0px; margin-top: 0px;">
		...
		<tr>
			<td style="padding: 20px 20px; line-height: 20px;">
				...
				<br /><br />
				You received this message because you  forgot your password on <span style="font-weight: bold; color: #000000;">{site_name}</span>!
				<br /><br />
				To reset your password please click on the link below:
				<br/>
				<a href="{reset_password_link}">{reset_password_link}</a>
				
				Or copy the folowing link in your adress bar:<br />
				{reset_password_link}
				<br />
