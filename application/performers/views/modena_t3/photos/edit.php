		...
		<div id="photo">
			...
			<div class="gray italic register_performer">
				...
				<div style="margin-left: 222px;">
					<?php echo form_submit('submit', lang('Save'),'class="red" style="width:98px;"')?>
					<?php echo form_button(array('id' => 'delete-bttn', 'class'=>'red', 'content' => 'Delete', 'style'=> 'width:98px;', 'onclick' => 'confirm_delete()'))?>
				</div>
                <?php echo form_close()?>
            </div>
        </div>
