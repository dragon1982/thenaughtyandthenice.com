<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
	<div class="content">
		<div class="title">
			<?php $performers_profile_title = lang('Performer\'s Profile Page') ?>
			<span class="eutemia italic"><?php echo substr($performers_profile_title, 0, 1)?></span><span class="helvetica italic"><?php echo substr($performers_profile_title,1)?></span>
		</div>
