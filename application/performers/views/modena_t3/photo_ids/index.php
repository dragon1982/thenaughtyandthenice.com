...
<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">	
	<div class="content">
		...
		<a href="<?php echo site_url('photo_id/add')?>" style="float:right"><?php echo form_button('add', lang('Add Photo ID'),'class="red"')?></a>
            ...
            <?php else:?>     
	            ...
	            <?php foreach ($photo_ids as $photo_id): ?>
					<tr class="<?php echo ($i % 2==0)?'even':'odd'?>">
		                ...
		                <td>
		                	<a href="<?php echo site_url('photo_id/delete/' . $photo_id->id)?>" onclick="return confirm('<?php echo lang('Are you sure you want to delete this item')?>')"><img src="<?php echo assets_url()?>images/icons/trash.gif" /></a>
		               </td>
		            </tr>
		            <?php $i++ ?>
	            <?php endforeach ?>
