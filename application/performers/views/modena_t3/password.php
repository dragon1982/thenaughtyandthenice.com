...
jQuery(function($){
	...
	<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
		<div class="content" id="profile">
			...
			<div class="gray italic studio_settings">
				...
				<div>
					...
					<span class="error message" htmlfor="old_password" generated="true"><?php echo form_error('old_password')?></span>
				</div>
				<div>
				...
				<div style="margin-left:223px;" onclick = "$('.change_pass').validate()"><button class="red" style="width:205px;"><?php echo lang('Save Changes') ?></button></div>
				</div>
				<?php echo form_close() ?>
