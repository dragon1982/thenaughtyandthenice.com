<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
	<div class="content">
		<div class="title">
			<?php $perfomers_banned_zones_title = lang('Perfomer\'s Banned Locations Page') ?>
			<span class="eutemia"><?php echo substr($perfomers_banned_zones_title,0,1) ?></span><span class="helvetica"><?php echo substr($perfomers_banned_zones_title,1) ?></span>
		</div>
		<div id="profile">		
			<div class="left" style="text-align: center;">
				...
				<?php echo form_open('')?>
					<ul style="list-style-type:none; width: 270px; float:left; overflow-y: scroll; height: 500px;" >
