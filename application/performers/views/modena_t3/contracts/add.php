		...
		<div class="content">
			...
			<div class="gray italic register_studio"> 				
				<div id="contracts">
						...
						<br/>
						<span style="display: inline-block; width:300px;margin-left: 222px;" id="upload-contract" class="uploader">
							<?php if($contract):?>								
				...
				<div style="margin-top:8px; margin-left:223px;">
					<button class="red"  onclick="$('.add_contract').validate()" style="width:206px;"> <?php echo lang('Add contract')?> </button><br/>
				</div>
