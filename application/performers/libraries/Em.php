...
class Em {
	...
	public function set($type, $message) {
		$this->messages = $this->CI->session->userdata('errors_and_messages');
		$this->messages[] = array('type' => $type, 'msg' => $message);
		
		$this->CI =& get_instance();
		$this->CI->session->set_userdata('errors_and_messages', $this->messages);
	}
	...
	public function get(){
		...
		$messages = $this->CI->session->userdata('errors_and_messages');
		$this->CI->session->unset_userdata('errors_and_messages');
