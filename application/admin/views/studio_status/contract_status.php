...
function change() {
	...
	<div id="content_status">
		<div class="content-box-header">
			<div class="status_name"><h3><?php echo $studio->username ?>'s <?php echo lang('contracts') ?></h3></div>
				...
				<table class="pagination" width="100%" rel="100">
					...
					<?php $i=0; //pentru a alterna culorile tabelului?>
						...
						<tr class="row_<?php echo ($i%2==0)?'2':'1' ?>">
							...
							<td><?php echo $studio->username ?></td>
							<td>
							...
							<td>
								<a href="<?php echo main_url('uploads/studios/'. $studio->id .'/'. $contract->name_on_disk) ?>"  target="_blank">
								...
								<a href="<?php echo site_url('studios/update_status/rejected/' . $contract->id . '/' . $studio->id) ?>">
								...
								<a href="<?php echo site_url('studios/update_status/approved/' . $contract->id . '/' . $studio->id) ?>">
						...
						<?php endforeach ?>
						<?php else: ?>
							<tr class="row_1"><td style="text-align:center;" colspan="5"><?php echo lang('Studio has no uploaded contracts') ?></td></tr>
						<?php endif; ?>					
					</tbody>
				</table>
