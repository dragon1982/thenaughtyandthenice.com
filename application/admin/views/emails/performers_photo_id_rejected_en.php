	...
	<table cellpadding="0" cellspacing="0" style="width: 600px; font-family: Arial; font-size: 14px; text-align: left; color: #505050; border: solid #DDDDDD 1px; padding: 0px; margin-top: 0px;">
		...
		<tr>
			<td style="padding: 20px 20px; line-height: 20px;">
				...
				<br /><br />
				Your photo ID uploaded on <span style="font-weight: bold; color: #000000;">{site_name}</span> was <span style="font-weight: bold; color: #DB0404;"> rejected</span>!
				<br /><br />
				
				Also, you can login into your {site_name} account <a href="{login_link}"> here </a> and reapload a new photo ID!
