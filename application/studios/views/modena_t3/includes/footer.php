<div id="footer" class="bold italic">
	<br/>
	<a href="<?php echo main_url(PREFORMERS_URL)?>"><?php echo lang('Performer\'s area')?></a>
	
	&nbsp;&nbsp;|&nbsp;&nbsp;
	
	<a href="<?php echo main_url(PREFORMERS_URL . '/register')?>" id="become_performer"><?php echo lang('$$Performers wanted$$')?></a>
	...
	<a href="<?php echo main_url(STUDIOS_URL)?>"><?php echo lang('Studios')?></a>
	
	&nbsp;&nbsp;|&nbsp;&nbsp;
	
	<a href="<?php echo main_url(AFFILIATES_URL)?>"><?php echo lang('Affiliates')?></a>
	...
	<a href="<?php echo main_url('documents/2257')?>"><?php echo lang('18 U.S.C 2257 Record-Keeping Requirements Compliance Statement ')?></a>
