...
<script type="text/javascript" src="<?php echo assets_url()?>js/jquery.ui.core.js"></script>
<script type="text/javascript" src="<?php echo assets_url()?>js/jquery.ui.widget.js"></script>
...
<script type="text/javascript" src="<?php echo assets_url()?>addons/fancybox/jquery.fancybox-1.3.4.js"></script>
