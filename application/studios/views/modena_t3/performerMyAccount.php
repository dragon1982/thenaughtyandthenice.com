 <div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
	<div class="content">
		...
		<div class="gray italic" style="padding: 10px; text-align: justify;">		
			...
			<?php $credits_red = '<span class="red">' . print_amount_by_currency($this->performer->credits) . '</span>' ?>			
			...
			<div style="margin:5px;">
				...
				<?php if( SETTINGS_CURRENCY_TYPE )://daca nu e in bani reali afisez suma si in real money?>
					<?php $equivalent = '<span class="red">' . print_amount_by_currency($this->performer->credits,TRUE) . '</span>'?>
			...
			<?php $unread_messages = '<a href="'.site_url('messenger').'"><span class="red">' . $this->performer->unread_messages . '</span></a>' ?> 
			<div style="margin:5px;"><?php echo sprintf(lang('You have %s unread message(s).'), $unread_messages) ?></div>
			
			<?php if($this->performer->contract_status !== 'approved'):?>
				<br />
				<div style="margin:5px">
					<a class="red" href="<?php echo site_url('contracts')?>"><?php echo sprintf(lang('Your contract is %s'),$this->performer->contract_status)?></a>
				</div>
			<?php endif?>
			
			<?php if($this->performer->photo_id_status !== 'approved'):?>
				<div style="margin:5px">
					<a class="red" href="<?php echo site_url('photo_id')?>"><?php echo sprintf(lang('Your photo ID is %s'),$this->performer->photo_id_status)?></a>
				</div>
			<?php endif?>	

			<?php if($this->performer->contract_status == 'approved' && $this->performer->photo_id_status == 'approved'):?>
				<div style="margin:5px">
					<?php echo lang('Your account is active!')?>
				</div>			
			<?php endif?>
			<div style="margin:20px 5px;"><a href="#"><img src="<?php echo assets_url()?>images/icons/guide.jpg" align="left"/><?php echo lang('View performer\'s manual') ?></a></div>
