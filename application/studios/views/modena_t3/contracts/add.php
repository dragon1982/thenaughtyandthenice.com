		...
		<div class="content">
			...
			<div class="gray italic" id="studio_settings"> 		
				...
				<div id="contracts">
					...
					<span class="error message" htmlfor="contract" generated="true"><?php echo form_error('contract')?></span>
				</div>				   							
			    <script type="text/javascript">
			    	jQuery(function($){
			    		createUploader();
				...
				<div>
					<br>
					<div onclick="$('.add_contract').validate()" style="margin-left:223px;"><button class="red" style="width:206px;"><?php echo lang('Add contract') ?></button></div>
				</div>	
				<?php echo form_close()?>
			<div class="clear"></div>
		</div>
