...
<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
		<div class="content">
			<div class="title">
				<?php $signup_step_3_title = lang('Signup step 2 - Select Category') ?>
			...
			<div class="gray italic register_performer">
				<div>
					...
					<span class="error message" htmlfor="cat" generated="true" style="vertical-align: top;"><?php echo form_error('category')?></span>
				</div>
