<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
	<div class="content">
		<div class="title">
			<?php $personal_details_page_title = lang('Performer\'s Personal Details Page') ?>
			<span class="eutemia "><?php echo substr($personal_details_page_title,0,1)?></span><span class="helvetica "><?php echo substr($personal_details_page_title,1)?></span>
		</div>
		<div id="profile">
