...
jQuery(function($){
	...
	$.validator.addMethod("hasAvatar", function(value,element) {		
		if( $('#avatar .qq-upload-list').children('li:visible').length > 0 ){
			return true;
		} else {
			return false;
		}
	...
	$(".register_performer").validate({
		...
		messages: {
			...
			check_lang:					"<?php echo lang('Please choose at least on language') ?>",
...
<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
		<div class="content">
			<div class="title">
				<?php $signup_step_4 = lang('Signup step 4 - About you')?>
			...
			<div class="gray italic register_performer">
				...
				<div id="avatar">
					...
					<br/>
					<span style="display: block; width:300px;margin-left: 372px;">
						<?php if($avatar):?>								
				...
				<div>
					...
					<?php foreach($languages as $language):?>
						<span style="display: block; padding-top: 3px; width:210px;"><label><span style="display: block; padding-top: 3px;"><?php echo form_checkbox('lang[]', $language->code, set_checkbox('lang', $language->code))?><span class="gray italic bold"><?php echo ucfirst($language->title)?></span></span></label></span>						
					<?php endforeach?>
					</span>
