            ...
            <?php else:?>      
	            ...
	            <?php foreach ($contracts as $contract): ?>
					<tr class="<?php echo ($i % 2==0)?'even':'odd'?>">
		                ...
		                <td>
		                	<a href="<?php echo main_url('uploads/performers/' . $contract->performer_id . '/others/' . $contract->name_on_disk)?>" target="_blank"><img src="<?php echo assets_url()?>images/find_on.png" /></a>			                
		                </td>
		                <td>
		                	<a href="<?php echo site_url('performer/contracts/delete/'.$contract->id)?>" onclick="return confirm('<?php echo lang('Are you sure you want to delete this item')?>')"><img src="<?php echo assets_url()?>images/icons/trash.gif" /></a>
		               </td>
		            </tr>
		            <?php $i++ ?>
	            <?php endforeach ?>
