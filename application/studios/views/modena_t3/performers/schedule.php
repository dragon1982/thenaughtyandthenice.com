...
$(window).load(function() {
    $('td.hour').click(function() {
        ...
        var parent = $(this);
        $.ajax({
            url: "<?php echo site_url('performer/settings/update_schedule')?>",
            type: "post",
            data: {
...
<div class="black_box_bg_middle"><div class="black_box_bg_top"><div class="black_box">
	<div class="content">
		<div class="title">
			<?php $my_schedule_title = lang('My Schedule') ?>
			<span class="eutemia"><?php echo substr($my_schedule_title,0,1)?></span><span class="helvetica"><?php echo substr($my_schedule_title,1)?></span>
		</div>
