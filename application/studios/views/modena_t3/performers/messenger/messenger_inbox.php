...
<script type="text/javascript">
	...
	function update_mail_list(folder){
		...
		$.ajax({
            url: "<?php echo site_url('performer/messenger/mail_list')?>",
            type: 'post',
            dataType: "json",
	...
	function update_mail_content(mail_id){
		...
		$.ajax({
            url: "<?php echo site_url('performer/messenger/mail')?>",
            type: 'post',
            dataType: "json",
	...
	function move_to_trash(elem, id){
		...
		setTimeout(function(){
			...
			$.ajax({
				url: "<?php echo site_url('performer/messenger/move_to_trash')?>",
				type: 'post',
				dataType: "json",
